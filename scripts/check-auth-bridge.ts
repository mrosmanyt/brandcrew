...
assert.match(readFileSync("extension/manifest.json", "utf8"), /"version": "0\.3\.0"/);
assert.match(readFileSync("extension/manifest.json", "utf8"), /"side_panel"/);
assert.match(readFileSync("extension/manifest.json", "utf8"), /sidePanel/);
