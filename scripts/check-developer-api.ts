...
import { API_KEY_PREFIX, API_KEY_RATE_LIMIT, V1_ENDPOINTS } from "../src/lib/api-catalog";
...
assert.equal(generated.prefix, generated.token.slice(0, 16));
...
assert.ok(!JSON.stringify(serialized).includes(generated.token.slice(16)));
