; CINEM Pro branded NSIS hooks (electron-builder include).
; Path: electron/resources (buildResources). Welcome is not inserted unless
; customWelcomePage exists — that is the branded first screen.
;
; Motion: optional AdvSplash / Splash fade of installer\splash.bmp before the
; wizard. NSIS cannot play video; glow frames (splash-0/1/2.bmp) are for
; regeneration / docs, not in-wizard animation.
