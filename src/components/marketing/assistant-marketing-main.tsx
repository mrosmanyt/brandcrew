...
type AssistantMarketingMainProps = {
  /** Homepage leads with Assistant only; product page keeps the Pro cross-sell kicker. */
  variant?: "home" | "product";
};

export function AssistantMarketingMain({ variant = "product" }: AssistantMarketingMainProps) {
    ...
    <main>
      <section className="mx-auto w-full max-w-6xl px-6 pt-16 pb-16 md:pt-24 md:pb-20">
        <p className="mkt-hero-kicker text-sm text-muted-foreground">
          {isHome ? CINEM_AI_ASSISTANT_NAME : `CINEM Pro · ${CINEM_AI_ASSISTANT_NAME}`}
        </p>
